...
% samoa = 10.6; 
% niskine = 10.9; 
Declin=0; %-10.9; %for NISKINe 2019/2020

%path='/volumes/Puao/data_archive/WaveChasers-DataArchive/SamoanPassage/Moorings/sp12/P1/Flowquest/rawdata/';
path='/Users/awaterhouse/Documents/GitHub/niskine-proc/fq/DocsFromLinkSys/';
...
%         
        ...
        if exist('IV')
            ...
            if exist('IV2','var');
                FQ.Velx(1:size(IV2,1),k)=(IV2(:,1)./1000); %Vy
                FQ.Vely(1:size(IV2,1),k)=(IV2(:,2)./1000); %Vx
...
save([path 'FQ_output-testdata.mat'],'FQ');
